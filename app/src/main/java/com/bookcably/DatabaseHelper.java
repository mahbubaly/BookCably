...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertBooking(String modelName, String brandName, String carNumber, int seatNumber, int costPerHour, int hours, int totalAmount, byte[] productImageByteArray) {
        ...
        values.put(COL_BOOKING_COST_PER_HOUR,totalAmount);
